...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('products')->insert([
            ...
            'short_description'=> 'Áo thun tay ngắn',
            'long_description'=> 'Áo thun tay ngắn 1',
            'status'=> 'inactive',
        ]);
        DB::table('products')->insert([
            'category_id'=>'1',
            ...
            'short_description'=> 'Áo thun tay ngắn',
            'long_description'=> 'Áo thun tay ngắn 2',
            'status'=> 'inactive',
        ]);
        DB::table('products')->insert([
            'category_id'=>'1',
            ...
            'discount_price'=> '11000',
            'short_description'=> 'Áo thun tay ngắn',
            'long_description'=> 'Áo thun tay ngắn 3',
            'status'=> 'inactive',
        ]);
        ...
        DB::table('products')->insert([
            ...
            'discount_price'=> '10000',
            'short_description'=> 'Áo thun tay ngắn',
            'long_description'=> 'Áo thun tay ngắn 4',
            'status'=> 'inactive',
        ]);
        DB::table('products')->insert([
            'category_id'=>'1',
            ...
            'discount_price'=> '10000',
            'short_description'=> 'Áo thun tay ngắn',
            'long_description'=> 'Áo thun tay ngắn 5',
            'status'=> 'inactive',
        ]);
