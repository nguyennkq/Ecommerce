 <!-- Topbar Start -->
 @php
       $banners = App\Models\Banner::where('status','active')->latest()->take(3)->get();
     ...
     <div class="row align-items-center py-3 px-xl-5">
         ...
         <div class="col-lg-3 col-6 text-right">
             ...
             <a href="{{route('cart')}}" class="btn border">
                 ...
                 <span class="badge" id="countCart">0</span>
             </a>
         </div>
     </div>
 </div>
                 ...
                 <div class="carousel-inner">
                     @foreach ($banners as $key => $item)
                         <div class="carousel-item {{ $key === 0 ? 'active' : '' }}" style="height: 410px;">
                             <img class="img-fluid" src="{{ Storage::url($item->banner_image) }}" alt="Image">
                             <div
                                 ...
                                 <div class="p-3" style="max-width: 700px;">
                                     ...
                                     <a href="{{ $item->banner_url }}" class="btn btn-light py-2 px-3">Shop Now</a>
                                 </div>
                             </div>
                         </div>
                     @endforeach
